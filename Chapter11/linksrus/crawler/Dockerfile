...
RUN GIT_SHA=$(git rev-parse --short HEAD) && \
    ...
    -o /go/bin/linksrus-crawler \
    github.com/PacktPublishing/Hands-On-Software-Engineering-with-Golang/Chapter11/linksrus/crawler
...
COPY --from=builder /go/bin/linksrus-crawler /go/bin/linksrus-crawler

ENTRYPOINT ["/go/bin/linksrus-crawler"]
