...
RUN GIT_SHA=$(git rev-parse --short HEAD) && \
    ...
    -o /go/bin/linksrus-linkgraph \
    github.com/PacktPublishing/Hands-On-Software-Engineering-with-Golang/Chapter11/linksrus/linkgraph
...
COPY --from=builder /go/bin/linksrus-linkgraph /go/bin/linksrus-linkgraph

ENTRYPOINT ["/go/bin/linksrus-linkgraph"]
