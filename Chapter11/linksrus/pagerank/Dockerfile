...
RUN GIT_SHA=$(git rev-parse --short HEAD) && \
    ...
    -o /go/bin/linksrus-pagerank \
    github.com/PacktPublishing/Hands-On-Software-Engineering-with-Golang/Chapter11/linksrus/pagerank
...
COPY --from=builder /go/bin/linksrus-pagerank /go/bin/linksrus-pagerank

ENTRYPOINT ["/go/bin/linksrus-pagerank"]
