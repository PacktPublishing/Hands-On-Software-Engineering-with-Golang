...
- The [front-end](../../Chapter11/linksrus/frontend) service from chapter 11.
- The [crawler](../../Chapter11/linksrus/crawler) service from chapter 11.
- The **distributed** [PageRank calculator](../linksrus/pagerank) service from this chapter.
- The [link-graph](../../Chapter11/linksrus/linkgraph) service from chapter 11.
- The [text indexer](../../Chapter11/linksrus/textindexer) service from chapter 11.
...
![The provisioned kubernetes resources from this chapter](./img/ch12-lru-k8s.png)
